    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 5:
                    _a.sent();
                    throw new Error("Screenshot does not match : ".concat(baseImagePath).concat("report/screenshots/".concat(process.platform, "/").concat(process.env.BRWS || "chrome", "/").concat(name, "_diff.png")));
